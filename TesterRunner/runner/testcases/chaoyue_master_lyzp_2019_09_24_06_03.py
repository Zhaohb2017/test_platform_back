...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        player2 = UserBehavior(789)
        player3 = UserBehavior(444)
        time.sleep(2)
        player1.SetGameType = "耒阳字牌"
        player2.SetGameType = "耒阳字牌"
        player3.SetGameType = "耒阳字牌"
        create_room_data = {'o_player': 3, 'o_round': 8, 'o_jszs': False, 'o_bdwh': True, 'o_bdydh': True, 'o_yxqp': False, 'o_dianpao_hu': 0, 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
