...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        player2.SetGameType = "邵阳放炮罚"
        player3.SetGameType = "邵阳放炮罚"
        create_room_data = {'o_player': 3, 'o_zimodouble': 1, 'o_red_black': '', 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
