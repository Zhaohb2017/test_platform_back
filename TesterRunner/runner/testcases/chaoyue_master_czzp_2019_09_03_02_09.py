...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        player2 = UserBehavior(312321)
        player3 = UserBehavior(321)
        time.sleep(2)
        player1.SetGameType = "郴州字牌"
        player2.SetGameType = "郴州字牌"
        player3.SetGameType = "郴州字牌"
        create_room_data = {'o_player': 3, 'o_round': 10, 'o_qihu': 9, 'o_double': 0, 'o_double_plus': 2, 'o_double_score': 0, 'o_tun': 3, 'o_zomoDouble': False, 'o_redBlack': False, 'o_maohu': True, 'o_dinapaobihu': 1, 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': '', 'o_difen': 1}
