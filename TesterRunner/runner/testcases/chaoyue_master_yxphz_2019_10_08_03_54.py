...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        player1 = UserBehavior(127683,127683,True)
        player2 = UserBehavior(127641)
        player3 = UserBehavior(127655)
        time.sleep(2)
        player1.SetGameType = "攸县碰胡子"
        player2.SetGameType = "攸县碰胡子"
        player3.SetGameType = "攸县碰胡子"
        create_room_data = {'o_player': 3, 'o_zhongzhuang': 1, 'o_jushu': 6, 'o_wanfa': 0, 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
