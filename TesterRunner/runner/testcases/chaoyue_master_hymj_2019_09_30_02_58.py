...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        time.sleep(2)
        player1.SetGameType = "衡阳麻将"
        player2.SetGameType = "衡阳麻将"
        create_room_data = {'o_player': 2, 'o_round': 5, 'o_yao': 1, 'o_quanrenqiu': False, 'o_douzhuang': False, 'o_choupai': False, 'o_bankerZhuaNiao': False, 'o_zhuaNiao': 1, 'o_double': 0, 'o_fanbei': '', 'o_doubleNew': False, 'o_double_score': '', 'o_double_plus': 2, 'o_doublePlusNewScore': 10, 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
