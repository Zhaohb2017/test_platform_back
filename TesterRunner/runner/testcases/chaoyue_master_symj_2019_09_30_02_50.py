...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        time.sleep(2)
        player1.SetGameType = "邵阳麻将"
        player2.SetGameType = "邵阳麻将"
        create_room_data = {'o_player': 2, 'o_round': 5, 'o_double_plus_new': False, 'o_daifeng': False, 'o_chi': False, 'o_qingyisechi': False, 'o_choupai': False, 'o_jiachui': False, 'o_lianchui': False, 'o_zhuaMa': 2, 'o_double': 0, 'o_double_score': '', 'o_double_plus': 2, 'o_doublePlusNewScore': 10, 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
