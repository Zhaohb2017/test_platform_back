...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        time.sleep(2)
        player1.SetGameType = "湘乡告胡子"
        player2.SetGameType = "湘乡告胡子"
        player3.SetGameType = "湘乡告胡子"
        create_room_data = {'o_player': 3, 'o_double': '', 'o_double_score': '', 'o_doublePlusNewScore': 100, 'o_duoble_hint': '', 'o_datuo': '', 'o_card_num': '抽牌20张', 'o_wanfa': '', 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
