...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        time.sleep(2)
        player1.SetGameType = "长沙麻将"
        player2.SetGameType = "长沙麻将"
        create_room_data = {'o_player': 2, 'o_round': 5, 'o_fengding': 0, 'o_double_plus': 2, 'o_zhongNiaoJiaFen': False, 'o_zhongNiaoFanBei': False, 'o_zhongNiao': 0, 'o_Zhuaniao': 0, 'o_xianjia': False, 'o_eighthongzhong': False, 'o_yizhihua': False, 'o_liuliushun': True, 'o_queyise': False, 'o_banbanhu': True, 'o_dasixi': True, 'o_bubugao': False, 'o_santong': False, 'o_zhongtusixi': False, 'o_zhongtuliuliushun': False, 'o_jiajianghu': False, 'o_qieyimen': False, 'o_chouforty': False, 'o_double': 0, 'o_double_score': '', 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
