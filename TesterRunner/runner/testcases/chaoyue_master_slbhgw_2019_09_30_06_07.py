...
class PHZTestCase(unittest.TestCase):
    def test_task(self):
        ...
        time.sleep(2)
        player1.SetGameType = "四六八红拐弯"
        player2.SetGameType = "四六八红拐弯"
        create_room_data = {'o_player': 2, 'o_round': '6', 'o_chou_card': '抽牌20张', 'o_double': 0, 'o_double_score': '', 'o_doublePlusNewScore': 5, 'o_double_plus': 2, 'o_card_num': '抽牌20张', 'roomTypeVuale': '普通创房', 'clubRoomTypeVuale': '', 'o_club_id': ''}
